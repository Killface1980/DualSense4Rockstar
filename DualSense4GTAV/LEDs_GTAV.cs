...
namespace DualSense4GTAV
{
    public class LEDs_GTAV : Script
    {
        ...
        private void OnTick(object sender, EventArgs e)
        {
            ...
            _obj.GetStat(out int bat, out bool isConnected);
            if (!isConnected && controllerConfig.showconmes)
            {
                GTA.UI.Notification.Show("DualSense4GTAV | Your controller is disconnected or discharged, please fix or press " + KeyConf
                  .showCommStat + " to hide this message.");
                return;
            }
            if (bat <= 15 && controllerConfig.showbatstat)
            {
                GTA.UI.Notification.Show("DualSense4GTAV | Your controller battery is  " + bat + " to hide this message press " + KeyConf
                  .toggleBatStat, true);
                //return;
            }
            ...
            if (controllerConfig.showWanted)
            {
                if (isSirenOn)
                {
                    _add2.rgbupdat2e(40, playerped.Health);
                    return;
                }
                ...
                switch (Game.Player.WantedLevel)
                {
                    ...
                    case 2:
                        _add2.rgbupdat2e(30, playerped.Health);
                        packet.instructions[2].type = InstructionType.PlayerLED;
                        packet.instructions[2].parameters = new object[6]
                    ...
                    case 3:
                        _add2.rgbupdat2e(20, playerped.Health);
                        packet.instructions[2].type = InstructionType.PlayerLED;
                        packet.instructions[2].parameters = new object[6]
                    ...
                    case 4:
                        _add2.rgbupdat2e(15, playerped.Health);
                        packet.instructions[2].type = InstructionType.PlayerLED;
                        packet.instructions[2].parameters = new object[6]
                    ...
                    case 5:
                        _add2.rgbupdat2e(5, playerped.Health);
                        packet.instructions[2].type = InstructionType.PlayerLED;
                        packet.instructions[2].parameters = new object[6]
