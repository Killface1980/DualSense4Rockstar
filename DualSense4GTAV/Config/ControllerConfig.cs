...
namespace DualSense4GTAV.Config;
    ...
    public void OnKeyDown(object sender, KeyEventArgs e)
    {
        if (e.KeyCode == KeyConf.showMenu)
        {
            if (!menu.Visible)
            {
                ...
                {
                    GTA.UI.Notification.Show("DualSense4GTAV | Due to a bug, the menu will flicker if a weapon is drafted. Please holster your weapon and press " + KeyConf.showMenu + " again to activate the menu.");// "% \n to hide this Press F8");
                    return;
                }
        ...
        else if (e.KeyCode == KeyConf.showBatStat)
        {
            ...
            GTA.UI.Notification.Show("DualSense4GTAV | Controller connection status: " + isconnected + " controller battery status: " + bat +
                                     ".");// "% \n to hide this Press F8");
        }
